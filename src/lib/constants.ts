...
/** Libellés de modèle à ne jamais proposer dans les listes déroulantes (dépôt / édition annonce). */
export const MODELES_EXCLUS_DEPOT_ANNONCE = new Set<string>([
  'Accessoire',
  'Autre',
  'Bague',
  'Ballerine',
  ...
  'Cardigan Prada',
  'Cardigan signature',
  'Cardigan style sweat',
  'Cardigan Web',
  'Cardigan zippé',
  'Casquette',
  'Ceinture',
  'Ceinture Chaîne d\'ancre',
  'Ceinture Chanel',
