  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToConversations(user.uid, role, (convos) => {
      ...
      if (convos.length > 0) {
        ...
        if (emptyDelayRef.current) return;
        emptyDelayRef.current = setTimeout(() => {
          emptyDelayRef.current = null;
          setHasLoadedOnce(true);
        }, 500);
      }
              ...
              {Array.from({ length: skeletonCount }, (_, i) => (
                <div
                  ...
                  style={{
                    ...
                    gap: 24,
                    padding: '18px 28px',
                    borderBottom: i < skeletonCount - 1 ? '1px solid #e8e6e3' : 'none',
                    backgroundColor: '#fff',
                    ['--skeleton-index' as string]: i,
                  }}
                >
                  <div className="catalogue-skeleton" style={{ width: 80, height: 80, borderRadius: 12, flexShrink: 0 }} />
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
                      <div className="catalogue-skeleton" style={{ height: 15, width: 140 }} />
                      <div className="catalogue-skeleton" style={{ height: 12, width: 48, flexShrink: 0 }} />
                    </div>
                    <div className="catalogue-skeleton" style={{ height: 13, width: '60%', marginTop: 8 }} />
                    <div className="catalogue-skeleton" style={{ height: 13, width: '85%', marginTop: 8 }} />
                  </div>
